...
public:
    ...
    void resolveSplit();
    int getDarkCharge() const;
    void consumeDarkCharge();
...
private:
    ...
    void chooseBelialIntent();
    int belialAttackDamage(int baseDamage) const;
    void triggerBelialPossession();
    void clearDebuffs();
    int rollPercent();
    ...
    bool belialPossessed;
    bool belialForceUltimate;
