...
std::vector<Card> CardDatabase::createIroncladCardPool()
{
    return {
        ...
        makeCard("heavy_blade", "重刃", CardType::Attack, CardRarity::Common, 2,
            ...
            "造成 18 点伤害。力量使伤害额外增加。", {makeEffect(CardEffectType::Damage, 18, CardTarget::Enemy, "strength_multiplier_5")}),
        ...
        makeCard("true_grit", "坚毅", CardType::Skill, CardRarity::Common, 1,
            ...
            "获得 10 点格挡。选择一张手牌并消耗。", {makeEffect(CardEffectType::Block, 10), makeEffect(CardEffectType::Exhaust, 1, CardTarget::Self, "choose_hand")}),
        ...
        makeCard("shockwave", "震荡波", CardType::Skill, CardRarity::Uncommon, 2,
            ...
            "对所有敌人施加 5 层虚弱和易伤。消耗。", {makeEffect(CardEffectType::ApplyWeak, 5, CardTarget::AllEnemies), makeEffect(CardEffectType::ApplyVulnerable, 5, CardTarget::AllEnemies), makeEffect(CardEffectType::Exhaust, 1)}, 1),
        ...
        makeCard("berserk", "狂暴", CardType::Skill, CardRarity::Rare, 0,
